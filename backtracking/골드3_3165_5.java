...
public class 골드3_3165_5 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        n = new StringBuilder(String.valueOf(Long.parseLong(st.nextToken()) + 1)).reverse();
    ...
    private static void roundUp(int idx) {
        ...
        n = new StringBuilder(String.valueOf(Long.parseLong(n.reverse().toString()) + add)).reverse();
    }
