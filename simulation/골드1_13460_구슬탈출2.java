        ...
        while (!queue.isEmpty()) {
            ...
            for (int d = 0; d < 4; d++) {
                ...
                if (isBlueHole) {
                    ...
                    // 빨간 구슬만 구멍에 빠졌다면 시도한 카운트 값을 반환
                    return beads.cnt + 1;
                }

                // 경우의 수를 줄이기 위해 두 구슬의 위치가 그대로인 경우에는 큐에 집어넣지 않음
