...
public class 골드5_21608_상어초등학교 {

    static int N, sum;  // N, 만족도 총 합
    static int[] students, dx = {-1, 0, 1, 0}, dy = {0, 1, 0, -1};  // 학생 배열, 상 우 하 좌
    static int[][] map; // 학생들이 앉은 map
    static Map<Integer, Set<Integer>> preferences;  // 학생별 좋아하는 학생들
